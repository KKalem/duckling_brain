...
#    """
#    angle in rads and in (-pi,pi)
#    returns the arc length of the circle
#    target and self are on the same circle
#    """
#    if angle_to_target < -np.pi or angle_to_target > np.pi:
#        return None
#    if angle_to_target == np.pi or angle_to_target == -np.pi:
#        return distance_to_target
#
#    return distance_to_target*angle_to_target/np.sin(angle_to_target)
